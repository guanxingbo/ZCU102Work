...
set Library     "hls"
set IPName      "ddr_hls_test"
set Version     "1.0"
set DisplayName "Ddr_hls_test"
set Revision    "1809071440"
...
set Interfaces {
    s_axi_BUS_A {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 start_signal_i W 0x0 "Data signal of start_signal_i" {{0 32 start_signal_i W 0 "Bit 31 to 0 Data signal of start_signal_i"}}} {0x18 start_signal_o R 0x0 "Data signal of start_signal_o" {{0 32 start_signal_o R 0 "Bit 31 to 0 Data signal of start_signal_o"}}} {0x1c start_signal_o_ctrl R 0x0 "Control signal of start_signal_o" {{0 1 start_signal_o_ap_vld R 0 "Control signal start_signal_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 hls_check R 0x0 "Data signal of hls_check" {{0 32 hls_check R 0 "Bit 31 to 0 Data signal of hls_check"}}} {0x24 hls_check_ctrl R 0x0 "Control signal of hls_check" {{0 1 hls_check_ap_vld R 0 "Control signal hls_check_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 num W 0x0 "Data signal of num" {{0 32 num W 0 "Bit 31 to 0 Data signal of num"}}} {0x30 saMaster W 0x0 "Data signal of saMaster" {{0 32 saMaster W 0 "Bit 31 to 0 Data signal of saMaster"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
