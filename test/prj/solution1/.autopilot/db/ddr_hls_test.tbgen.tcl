set C_TypeInfoList {{ 
"ddr_hls_test" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"start_signal": [[],{ "pointer":  {"scalar": "int"}}] }, {"hls_check": [[],{ "pointer":  {"scalar": "int"}}] }, {"num": [[],{ "pointer":  {"scalar": "int"}}] }, {"saMaster": [[],{ "pointer":  {"scalar": "long long unsigned int"}}] }],[],""]
}}
set moduleName ddr_hls_test
...
set C_modelName {ddr_hls_test}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 64 regular {axi_master 2}  }
	{ start_signal int 32 regular {axi_slave 2}  }
	{ hls_check int 32 regular {axi_slave 1}  }
	{ num int 32 regular {axi_slave 0}  }
	{ saMaster int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "saMaster","cData": "long long unsigned int","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "saMaster","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 10239,"step" : 1}]}]}]} , 
 	{ "Name" : "start_signal", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "start_signal","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":16, "out":24}, "offset_end" : {"in":23, "out":31}} , 
 	{ "Name" : "hls_check", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "hls_check","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":32}, "offset_end" : {"out":39}} , 
 	{ "Name" : "num", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "num","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "saMaster", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":48}, "offset_end" : {"in":55}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_A_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "BUS_A", "role": "AWADDR" },"address":[{"name":"ddr_hls_test","role":"start","value":"0","valid_bit":"0"},{"name":"ddr_hls_test","role":"continue","value":"0","valid_bit":"4"},{"name":"ddr_hls_test","role":"auto_start","value":"0","valid_bit":"7"},{"name":"start_signal","role":"data","value":"16"},{"name":"num","role":"data","value":"40"},{"name":"saMaster","role":"data","value":"48"}] },
	...
	{ "name": "s_axi_BUS_A_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "BUS_A", "role": "ARADDR" },"address":[{"name":"ddr_hls_test","role":"start","value":"0","valid_bit":"0"},{"name":"ddr_hls_test","role":"done","value":"0","valid_bit":"1"},{"name":"ddr_hls_test","role":"idle","value":"0","valid_bit":"2"},{"name":"ddr_hls_test","role":"ready","value":"0","valid_bit":"3"},{"name":"ddr_hls_test","role":"auto_start","value":"0","valid_bit":"7"},{"name":"start_signal","role":"data","value":"24"}, {"name":"start_signal","role":"valid","value":"28","valid_bit":"0"},{"name":"hls_check","role":"data","value":"32"}, {"name":"hls_check","role":"valid","value":"36","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "start_signal", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "hls_check", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "num", "Type" : "None", "Direction" : "I"},
			{"Name" : "saMaster", "Type" : "None", "Direction" : "I"},
			{"Name" : "addr_bram", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.addr_bram_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddr_hls_test_BUS_A_s_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddr_hls_test_gmem_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	ddr_hls_test {
		gmem {Type IO LastRead 13 FirstWrite 6}
		start_signal {Type IO LastRead 1 FirstWrite 2}
		hls_check {Type O LastRead -1 FirstWrite 0}
		num {Type I LastRead 1 FirstWrite -1}
		saMaster {Type I LastRead 0 FirstWrite -1}
		addr_bram {Type I LastRead -1 FirstWrite -1}}}
...
set busDeadlockParameterList { 
	{ gmem { NUM_READ_OUTSTANDING 1 NUM_WRITE_OUTSTANDING 1 MAX_READ_BURST_LENGTH 4 MAX_WRITE_BURST_LENGTH 4 } } \
}
