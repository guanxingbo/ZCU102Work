...
ddr_hls_test::ddr_hls_test(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_CS_fsm_state13 );
    sensitive << ( i_2_reg_209 );

    SC_METHOD(thread_gmem_ARADDR);
    sensitive << ( ap_CS_fsm_state15 );
    sensitive << ( saMaster2_sum3_cast_fu_346_p1 );
    sensitive << ( ap_reg_ioackin_gmem_ARREADY );
    ...
    sensitive << ( saMaster2_sum_cast_fu_297_p1 );
    sensitive << ( ap_reg_ioackin_gmem_AWREADY );
    ...
    SC_METHOD(thread_grp_load_fu_220_p1);
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_1_fu_252_p2 );
    sensitive << ( ap_CS_fsm_state23 );
    sensitive << ( res_check_fu_98 );
    ...
    SC_METHOD(thread_i_1_cast2_fu_263_p1);
    sensitive << ( i_1_reg_198 );

    SC_METHOD(thread_i_2_cast1_fu_311_p1);
    sensitive << ( i_2_reg_209 );

    SC_METHOD(thread_i_3_fu_321_p2);
    sensitive << ( i_2_reg_209 );
    ...
    SC_METHOD(thread_j_cast_fu_248_p1);
    sensitive << ( j_reg_187 );

    SC_METHOD(thread_res_check_1_fu_364_p2);
    sensitive << ( res_check_fu_98 );
    sensitive << ( tmp_7_fu_359_p2 );

    SC_METHOD(thread_saMaster2_sum3_cast_fu_346_p1);
    sensitive << ( saMaster2_sum3_reg_465 );

    SC_METHOD(thread_saMaster2_sum3_fu_341_p2);
    sensitive << ( tmp_10_cast_reg_375 );
    sensitive << ( tmp_9_cast_fu_337_p1 );

    SC_METHOD(thread_saMaster2_sum_cast_fu_297_p1);
    sensitive << ( saMaster2_sum_reg_436 );

    SC_METHOD(thread_saMaster2_sum_fu_292_p2);
    sensitive << ( tmp_10_cast_reg_375 );
    sensitive << ( tmp_5_cast_fu_288_p1 );

    SC_METHOD(thread_start_signal_o);
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_1_fu_252_p2 );
    sensitive << ( grp_load_fu_220_p1 );
    ...
    SC_METHOD(thread_tmp_10_cast_fu_233_p1);
    sensitive << ( tmp_5_fu_223_p4 );

    SC_METHOD(thread_tmp_1_fu_252_p2);
    sensitive << ( run_cnt_reg_391 );
    sensitive << ( j_cast_fu_248_p1 );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_tmp_2_fu_284_p2);
    sensitive << ( j_cast_reg_396 );
    sensitive << ( i_1_cast2_reg_413 );

    SC_METHOD(thread_tmp_4_fu_279_p1);
    sensitive << ( i_1_reg_198 );

    SC_METHOD(thread_tmp_5_cast_fu_288_p1);
    sensitive << ( addr_bram_q0 );

    SC_METHOD(thread_tmp_5_fu_223_p4);
    sensitive << ( saMaster );

    SC_METHOD(thread_tmp_6_fu_356_p1);
    sensitive << ( tmp_s_reg_460 );

    SC_METHOD(thread_tmp_7_fu_359_p2);
    sensitive << ( gmem_addr_1_read_reg_476 );
    sensitive << ( ap_CS_fsm_state23 );
    sensitive << ( tmp_6_fu_356_p1 );

    SC_METHOD(thread_tmp_8_fu_327_p1);
    sensitive << ( i_2_reg_209 );

    SC_METHOD(thread_tmp_9_cast_fu_337_p1);
    sensitive << ( addr_bram_q0 );
    ...
    sc_trace(mVcdFile, tmp_10_cast_fu_233_p1, "tmp_10_cast_fu_233_p1");
    sc_trace(mVcdFile, tmp_10_cast_reg_375, "tmp_10_cast_reg_375");
    sc_trace(mVcdFile, run_cnt_reg_391, "run_cnt_reg_391");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_fu_237_p2, "tmp_fu_237_p2");
    sc_trace(mVcdFile, j_cast_fu_248_p1, "j_cast_fu_248_p1");
    sc_trace(mVcdFile, j_cast_reg_396, "j_cast_reg_396");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, j_1_fu_257_p2, "j_1_fu_257_p2");
    sc_trace(mVcdFile, j_1_reg_405, "j_1_reg_405");
    sc_trace(mVcdFile, i_1_cast2_fu_263_p1, "i_1_cast2_fu_263_p1");
    sc_trace(mVcdFile, i_1_cast2_reg_413, "i_1_cast2_reg_413");
    ...
    sc_trace(mVcdFile, saMaster2_sum_fu_292_p2, "saMaster2_sum_fu_292_p2");
    sc_trace(mVcdFile, saMaster2_sum_reg_436, "saMaster2_sum_reg_436");
    sc_trace(mVcdFile, ap_sig_ioackin_gmem_AWREADY, "ap_sig_ioackin_gmem_AWREADY");
    sc_trace(mVcdFile, i_3_fu_321_p2, "i_3_fu_321_p2");
    sc_trace(mVcdFile, i_3_reg_450, "i_3_reg_450");
    sc_trace(mVcdFile, ap_CS_fsm_state13, "ap_CS_fsm_state13");
    sc_trace(mVcdFile, exitcond_fu_315_p2, "exitcond_fu_315_p2");
    sc_trace(mVcdFile, tmp_s_fu_332_p2, "tmp_s_fu_332_p2");
    sc_trace(mVcdFile, tmp_s_reg_460, "tmp_s_reg_460");
    sc_trace(mVcdFile, saMaster2_sum3_fu_341_p2, "saMaster2_sum3_fu_341_p2");
    sc_trace(mVcdFile, saMaster2_sum3_reg_465, "saMaster2_sum3_reg_465");
    sc_trace(mVcdFile, ap_CS_fsm_state14, "ap_CS_fsm_state14");
    sc_trace(mVcdFile, ap_sig_ioackin_gmem_ARREADY, "ap_sig_ioackin_gmem_ARREADY");
    sc_trace(mVcdFile, gmem_addr_1_read_reg_476, "gmem_addr_1_read_reg_476");
    ...
    sc_trace(mVcdFile, i_2_reg_209, "i_2_reg_209");
    sc_trace(mVcdFile, ap_CS_fsm_state23, "ap_CS_fsm_state23");
    sc_trace(mVcdFile, tmp_4_fu_279_p1, "tmp_4_fu_279_p1");
    sc_trace(mVcdFile, tmp_8_fu_327_p1, "tmp_8_fu_327_p1");
    sc_trace(mVcdFile, saMaster2_sum_cast_fu_297_p1, "saMaster2_sum_cast_fu_297_p1");
    sc_trace(mVcdFile, saMaster2_sum3_cast_fu_346_p1, "saMaster2_sum3_cast_fu_346_p1");
    ...
    sc_trace(mVcdFile, res_check_fu_98, "res_check_fu_98");
    sc_trace(mVcdFile, res_check_1_fu_364_p2, "res_check_1_fu_364_p2");
    sc_trace(mVcdFile, grp_load_fu_220_p1, "grp_load_fu_220_p1");
    sc_trace(mVcdFile, tmp_5_fu_223_p4, "tmp_5_fu_223_p4");
    sc_trace(mVcdFile, tmp_5_cast_fu_288_p1, "tmp_5_cast_fu_288_p1");
    sc_trace(mVcdFile, i_2_cast1_fu_311_p1, "i_2_cast1_fu_311_p1");
    sc_trace(mVcdFile, tmp_9_cast_fu_337_p1, "tmp_9_cast_fu_337_p1");
    sc_trace(mVcdFile, tmp_6_fu_356_p1, "tmp_6_fu_356_p1");
...
void ddr_hls_test::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(tmp_1_fu_252_p2.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        i_1_reg_198 = ap_const_lv14_0;
    } else if ((esl_seteq<1,1,1>(gmem_BVALID.read(), ap_const_logic_1) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state12.read()))) {
        i_1_reg_198 = i_reg_421.read();
    }
    if ((esl_seteq<1,1,1>(exitcond1_fu_267_p2.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
        i_2_reg_209 = ap_const_lv14_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state23.read())) {
        i_2_reg_209 = i_3_reg_450.read();
    }
    if ((esl_seteq<1,1,1>(exitcond_fu_315_p2.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read()))) {
        j_reg_187 = j_1_reg_405.read();
    } else if ((esl_seteq<1,1,1>(tmp_fu_237_p2.read(), ap_const_lv1_1) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        j_reg_187 = ap_const_lv31_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state23.read())) {
        res_check_fu_98 = res_check_1_fu_364_p2.read();
    } else if ((esl_seteq<1,1,1>(tmp_fu_237_p2.read(), ap_const_lv1_1) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        res_check_fu_98 = ap_const_lv1_1;
    }
    if ((esl_seteq<1,1,1>(gmem_RVALID.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state22.read()))) {
        gmem_addr_1_read_reg_476 = gmem_RDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_1_cast2_reg_413 = i_1_cast2_fu_263_p1.read();
        i_reg_421 = i_fu_273_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read())) {
        i_3_reg_450 = i_3_fu_321_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        j_1_reg_405 = j_1_fu_257_p2.read();
        j_cast_reg_396 = j_cast_fu_248_p1.read();
    }
    if ((esl_seteq<1,1,1>(tmp_fu_237_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        run_cnt_reg_391 = num.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state14.read())) {
        saMaster2_sum3_reg_465 = saMaster2_sum3_fu_341_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        saMaster2_sum_reg_436 = saMaster2_sum_fu_292_p2.read();
        tmp_2_reg_431 = tmp_2_fu_284_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        tmp_10_cast_reg_375 = tmp_10_cast_fu_233_p1.read();
    }
    if ((esl_seteq<1,1,1>(exitcond_fu_315_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read()))) {
        tmp_s_reg_460 = tmp_s_fu_332_p2.read();
    }
}

void ddr_hls_test::thread_addr_bram_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read())) {
        addr_bram_address0 =  (sc_lv<14>) (tmp_8_fu_327_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        addr_bram_address0 =  (sc_lv<14>) (tmp_4_fu_279_p1.read());
    } else {
...
void ddr_hls_test::thread_ap_done() {
    if ((esl_seteq<1,1,1>(tmp_1_fu_252_p2.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
...
void ddr_hls_test::thread_exitcond1_fu_267_p2() {
    exitcond1_fu_267_p2 = (!i_1_reg_198.read().is_01() || !ap_const_lv14_2800.is_01())? sc_lv<1>(): sc_lv<1>(i_1_reg_198.read() == ap_const_lv14_2800);
}

void ddr_hls_test::thread_exitcond_fu_315_p2() {
    exitcond_fu_315_p2 = (!i_2_reg_209.read().is_01() || !ap_const_lv14_2800.is_01())? sc_lv<1>(): sc_lv<1>(i_2_reg_209.read() == ap_const_lv14_2800);
}

void ddr_hls_test::thread_gmem_ARADDR() {
    gmem_ARADDR =  (sc_lv<32>) (saMaster2_sum3_cast_fu_346_p1.read());
}
...
void ddr_hls_test::thread_gmem_AWADDR() {
    gmem_AWADDR =  (sc_lv<32>) (saMaster2_sum_cast_fu_297_p1.read());
}
...
void ddr_hls_test::thread_gmem_WDATA() {
    gmem_WDATA = esl_sext<64,32>(tmp_2_reg_431.read());
}
...
void ddr_hls_test::thread_grp_load_fu_220_p1() {
    grp_load_fu_220_p1 = res_check_fu_98.read();
}

void ddr_hls_test::thread_hls_check() {
    if ((esl_seteq<1,1,1>(tmp_fu_237_p2.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void ddr_hls_test::thread_hls_check_ap_vld() {
    if (((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) || 
         (esl_seteq<1,1,1>(tmp_fu_237_p2.read(), ap_const_lv1_0) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())))) {
...
void ddr_hls_test::thread_i_1_cast2_fu_263_p1() {
    i_1_cast2_fu_263_p1 = esl_zext<32,14>(i_1_reg_198.read());
}

void ddr_hls_test::thread_i_2_cast1_fu_311_p1() {
    i_2_cast1_fu_311_p1 = esl_zext<32,14>(i_2_reg_209.read());
}

void ddr_hls_test::thread_i_3_fu_321_p2() {
    i_3_fu_321_p2 = (!i_2_reg_209.read().is_01() || !ap_const_lv14_1.is_01())? sc_lv<14>(): (sc_biguint<14>(i_2_reg_209.read()) + sc_biguint<14>(ap_const_lv14_1));
}

void ddr_hls_test::thread_i_fu_273_p2() {
    i_fu_273_p2 = (!i_1_reg_198.read().is_01() || !ap_const_lv14_1.is_01())? sc_lv<14>(): (sc_biguint<14>(i_1_reg_198.read()) + sc_biguint<14>(ap_const_lv14_1));
}

void ddr_hls_test::thread_j_1_fu_257_p2() {
    j_1_fu_257_p2 = (!j_reg_187.read().is_01() || !ap_const_lv31_1.is_01())? sc_lv<31>(): (sc_biguint<31>(j_reg_187.read()) + sc_biguint<31>(ap_const_lv31_1));
}

void ddr_hls_test::thread_j_cast_fu_248_p1() {
    j_cast_fu_248_p1 = esl_zext<32,31>(j_reg_187.read());
}

void ddr_hls_test::thread_res_check_1_fu_364_p2() {
    res_check_1_fu_364_p2 = (tmp_7_fu_359_p2.read() | res_check_fu_98.read());
}

void ddr_hls_test::thread_saMaster2_sum3_cast_fu_346_p1() {
    saMaster2_sum3_cast_fu_346_p1 = esl_zext<64,30>(saMaster2_sum3_reg_465.read());
}

void ddr_hls_test::thread_saMaster2_sum3_fu_341_p2() {
    saMaster2_sum3_fu_341_p2 = (!tmp_9_cast_fu_337_p1.read().is_01() || !tmp_10_cast_reg_375.read().is_01())? sc_lv<30>(): (sc_biguint<30>(tmp_9_cast_fu_337_p1.read()) + sc_biguint<30>(tmp_10_cast_reg_375.read()));
}

void ddr_hls_test::thread_saMaster2_sum_cast_fu_297_p1() {
    saMaster2_sum_cast_fu_297_p1 = esl_zext<64,30>(saMaster2_sum_reg_436.read());
}

void ddr_hls_test::thread_saMaster2_sum_fu_292_p2() {
    saMaster2_sum_fu_292_p2 = (!tmp_5_cast_fu_288_p1.read().is_01() || !tmp_10_cast_reg_375.read().is_01())? sc_lv<30>(): (sc_biguint<30>(tmp_5_cast_fu_288_p1.read()) + sc_biguint<30>(tmp_10_cast_reg_375.read()));
}

void ddr_hls_test::thread_start_signal_o() {
    if ((esl_seteq<1,1,1>(tmp_1_fu_252_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        if (esl_seteq<1,1,1>(ap_const_lv1_1, grp_load_fu_220_p1.read())) {
            start_signal_o = ap_const_lv32_206;
        } else if (esl_seteq<1,1,1>(ap_const_lv1_0, grp_load_fu_220_p1.read())) {
...
void ddr_hls_test::thread_start_signal_o_ap_vld() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
          esl_seteq<1,1,1>(tmp_1_fu_252_p2.read(), ap_const_lv1_0) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, grp_load_fu_220_p1.read())) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
          esl_seteq<1,1,1>(tmp_1_fu_252_p2.read(), ap_const_lv1_0) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, grp_load_fu_220_p1.read())))) {
...
void ddr_hls_test::thread_tmp_10_cast_fu_233_p1() {
    tmp_10_cast_fu_233_p1 = esl_zext<30,29>(tmp_5_fu_223_p4.read());
}

void ddr_hls_test::thread_tmp_1_fu_252_p2() {
    tmp_1_fu_252_p2 = (!j_cast_fu_248_p1.read().is_01() || !run_cnt_reg_391.read().is_01())? sc_lv<1>(): (sc_bigint<32>(j_cast_fu_248_p1.read()) < sc_bigint<32>(run_cnt_reg_391.read()));
}

void ddr_hls_test::thread_tmp_2_fu_284_p2() {
    tmp_2_fu_284_p2 = (!i_1_cast2_reg_413.read().is_01() || !j_cast_reg_396.read().is_01())? sc_lv<32>(): (sc_biguint<32>(i_1_cast2_reg_413.read()) + sc_biguint<32>(j_cast_reg_396.read()));
}

void ddr_hls_test::thread_tmp_4_fu_279_p1() {
    tmp_4_fu_279_p1 = esl_zext<64,14>(i_1_reg_198.read());
}

void ddr_hls_test::thread_tmp_5_cast_fu_288_p1() {
    tmp_5_cast_fu_288_p1 = esl_zext<30,24>(addr_bram_q0.read());
}

void ddr_hls_test::thread_tmp_5_fu_223_p4() {
    tmp_5_fu_223_p4 = saMaster.read().range(31, 3);
}

void ddr_hls_test::thread_tmp_6_fu_356_p1() {
    tmp_6_fu_356_p1 = esl_sext<64,32>(tmp_s_reg_460.read());
}

void ddr_hls_test::thread_tmp_7_fu_359_p2() {
    tmp_7_fu_359_p2 = (!gmem_addr_1_read_reg_476.read().is_01() || !tmp_6_fu_356_p1.read().is_01())? sc_lv<1>(): sc_lv<1>(gmem_addr_1_read_reg_476.read() == tmp_6_fu_356_p1.read());
}

void ddr_hls_test::thread_tmp_8_fu_327_p1() {
    tmp_8_fu_327_p1 = esl_zext<64,14>(i_2_reg_209.read());
}

void ddr_hls_test::thread_tmp_9_cast_fu_337_p1() {
    tmp_9_cast_fu_337_p1 = esl_zext<30,24>(addr_bram_q0.read());
}

void ddr_hls_test::thread_tmp_fu_237_p2() {
    tmp_fu_237_p2 = (!start_signal_i.read().is_01() || !ap_const_lv32_7CA.is_01())? sc_lv<1>(): sc_lv<1>(start_signal_i.read() == ap_const_lv32_7CA);
}

void ddr_hls_test::thread_tmp_s_fu_332_p2() {
    tmp_s_fu_332_p2 = (!i_2_cast1_fu_311_p1.read().is_01() || !j_cast_reg_396.read().is_01())? sc_lv<32>(): (sc_biguint<32>(i_2_cast1_fu_311_p1.read()) + sc_biguint<32>(j_cast_reg_396.read()));
}
...
void ddr_hls_test::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(exitcond1_fu_267_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
        ...
        case 2048 : 
            ...
            break;
        case 4096 : 
            if ((esl_seteq<1,1,1>(exitcond_fu_315_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read()))) {
                ap_NS_fsm = ap_ST_fsm_state3;
            } else {
