...
set ::env(LD_LIBRARY_PATH) /home/guan/Xilinx/Vivado/2018.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/guan/Xilinx/Vivado/2018.2/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/guan/Xilinx/Vivado/2018.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/guan/Xilinx/Vivado/2018.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/guan/Xilinx/Vivado/2018.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ddr_hls_test.autotvin.dat"
	set constFileTvOut       "ddr_hls_test.autotvout.dat"
	set constFileHdlTvIn     "ddr_hls_test.autohdltvin.dat"
	set constFileHdlTvOut    "ddr_hls_test.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
