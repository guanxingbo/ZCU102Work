...
{
//	printf("%s+%d+%d",device,width,height);
...
//      rgb[index * 3 + 5] = minmax(0, (y1 + 454 * u) >> 8, 255);
		...
		rgb[index * 3 + 0] = minmax(0, (int)(y0 + (1.370705 * (v-128))), 255);
		rgb[index * 3 + 1] = minmax(0, (int)(y0 - (0.698001 * (v-128)) - (0.337633 * (u-128))), 255);
		rgb[index * 3 + 2] = minmax(0, (int)(y0 + (1.732446 * (u-128))), 255);
		rgb[index * 3 + 3] = minmax(0, (int)(y1 + (1.370705 * (v-128))), 255);
		rgb[index * 3 + 4] = minmax(0, (int)(y1 - (0.698001 * (v-128)) - (0.337633 * (u-128))), 255);
		rgb[index * 3 + 5] = minmax(0, (int)(y1 + (1.732446 * (u-128))), 255);
    }
  }
  return rgb;
}
...
int readCam(char * path, uint32_t width , uint32_t height){
//
//	FILE *camera, *grab;
...
//
//    float data[SIZE];
//    long length = fread(data, sizeof(data[0]), SIZE, camera);
...
//    return 0;
	  ...
	  camera_t* camera = camera_open(path, width, height);
