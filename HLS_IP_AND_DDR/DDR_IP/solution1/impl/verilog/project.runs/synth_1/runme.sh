...
HD_PWD='/home/guan/Xilinx/Project/HLS_IP_AND_DDR/DDR_IP/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr_hls_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr_hls_test.tcl
