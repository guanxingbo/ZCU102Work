...
HD_PWD='/home/guan/Xilinx/Project/DMAtest/DMAtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmadesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmadesign_wrapper.tcl -notrace
