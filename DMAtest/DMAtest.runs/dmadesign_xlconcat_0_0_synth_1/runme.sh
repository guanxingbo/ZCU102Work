...
HD_PWD='/home/guan/Xilinx/Project/DMAtest/DMAtest.runs/dmadesign_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmadesign_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmadesign_xlconcat_0_0.tcl
