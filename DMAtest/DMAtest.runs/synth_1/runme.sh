...
HD_PWD='/home/guan/Xilinx/Project/DMAtest/DMAtest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmadesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmadesign_wrapper.tcl
