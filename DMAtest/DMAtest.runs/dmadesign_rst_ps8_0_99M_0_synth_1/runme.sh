...
HD_PWD='/home/guan/Xilinx/Project/DMAtest/DMAtest.runs/dmadesign_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmadesign_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmadesign_rst_ps8_0_99M_0.tcl
