...
HD_PWD='/home/guan/Xilinx/Project/DMAtest/DMAtest.runs/dmadesign_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmadesign_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmadesign_axis_data_fifo_0_0.tcl
