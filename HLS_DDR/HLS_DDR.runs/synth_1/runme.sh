...
HD_PWD='/home/guan/Xilinx/Project/HLS_DDR/HLS_DDR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_base_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_base_wrapper.tcl
