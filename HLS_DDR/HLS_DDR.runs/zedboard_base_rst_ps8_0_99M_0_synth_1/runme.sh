...
HD_PWD='/home/guan/Xilinx/Project/HLS_DDR/HLS_DDR.runs/zedboard_base_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_base_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_base_rst_ps8_0_99M_0.tcl
